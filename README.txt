...
evaluation is always used.  Integers in many common programming
languages can be recognized:
...
I normally bind `mjr-meta-eval' to "ESC ESC :" -- that is hit escape
twice and then colon.  I think of `mjr-meta-eval' as an extended
version of `eval-expression' that is normally bound to "ESC :".

     (keymap-global-set "ESC ESC :"   'mjr-meta-eval)
            
The easiest way to install mjr-meta-eval is to pull it directly
from github:
